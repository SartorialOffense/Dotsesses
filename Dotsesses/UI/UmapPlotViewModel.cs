...
/// <summary>
/// ViewModel for the UMAP (Uniform Manifold Approximation and Projection) plot visualization.
/// </summary>
public partial class UmapPlotViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private int _nNeighbors = 15;

    [ObservableProperty]
    private double _minDist = 0.1;

    public UmapPlotViewModel(
        ...
        HoverDelayService hoverDelayService)
    {
        ...
        _messenger.Register<StudentHoverMessage>(this, (r, m) =>
        {
            ...
            if (m.StudentId == null || m.Source != "umap")
            {
    ...
    /// <summary>
    /// Called when NNeighbors changes - debounce regeneration.
    /// </summary>
    partial void OnNNeighborsChanged(int value)
    {
        DebouncedRegenerate();
    }

    /// <summary>
    /// Called when MinDist changes - debounce regeneration.
    /// </summary>
    partial void OnMinDistChanged(double value)
    {
        DebouncedRegenerate();
    }
    ...
    /// <summary>
    /// Generates the UMAP plot with the given data.
    /// </summary>
        ...
        ThemeName theme = ThemeName.DarkMode)
    {
        ...
        try
        {
            ...
            var (svgContent, dataPoints) = _dimRedService.GenerateUmapPlot(
